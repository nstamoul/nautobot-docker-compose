    ...
    def post(self, request):
        ...
        if action == "start":
            ...
            payload = {
                ...
                "vpn_client": form.cleaned_data.get("vpn_client") or None,
                "profile_name": form.cleaned_data.get("profile_name") or None,
                "usergroup": form.cleaned_data.get("usergroup") or None,
