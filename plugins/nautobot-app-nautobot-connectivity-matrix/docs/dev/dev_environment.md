...
- `project_name`: the default docker compose project name (default: `nautobot-connectivity-matrix`)
...
Using **Invoke** these configuration options can be overridden using [several methods](https://docs.pyinvoke.org/en/stable/concepts/configuration.html). Perhaps the simplest is setting an environment variable `INVOKE_NAUTOBOT_CONNECTIVITY_MATRIX_VARIABLE_NAME` where `VARIABLE_NAME` is the variable you are trying to override. The only exception is `compose_files`, because it is a list it must be overridden in a YAML file. There is an example `invoke.yml` (`invoke.example.yml`) in this directory which can be used as a starting point.
...
#14 naming to docker.io/nautobot-connectivity-matrix/nautobot:3.0.0-py3.12 done
```
...
Creating network "nautobot_connectivity_matrix_default" with the default driver
Creating volume "nautobot_connectivity_matrix_postgres_data" with default driver
Creating nautobot_connectivity_matrix_redis_1 ...
Creating nautobot_connectivity_matrix_docs_1  ...
Creating nautobot_connectivity_matrix_postgres_1 ...
Creating nautobot_connectivity_matrix_postgres_1 ... done
Creating nautobot_connectivity_matrix_redis_1    ... done
Creating nautobot_connectivity_matrix_nautobot_1 ...
Creating nautobot_connectivity_matrix_docs_1     ... done
Creating nautobot_connectivity_matrix_nautobot_1 ... done
Creating nautobot_connectivity_matrix_worker_1   ...
Creating nautobot_connectivity_matrix_worker_1   ... done
...
ee90fbfabd77   nautobot-connectivity-matrix/nautobot:3.0.0-py3.12  "nautobot-server rqw…"   16 seconds ago   Up 13 seconds                                               nautobot_connectivity_matrix_worker_1
b8adb781d013   nautobot-connectivity-matrix/nautobot:3.0.0-py3.12  "/docker-entrypoint.…"   20 seconds ago   Up 15 seconds   0.0.0.0:8080->8080/tcp, :::8080->8080/tcp   nautobot_connectivity_matrix_nautobot_1
d64ebd60675d   nautobot-connectivity-matrix/nautobot:3.0.0-py3.12  "mkdocs serve -v -a …"   25 seconds ago   Up 18 seconds   0.0.0.0:8001->8080/tcp, :::8001->8080/tcp   nautobot_connectivity_matrix_docs_1
e72d63129b36   postgres:13-alpine               "docker-entrypoint.s…"   25 seconds ago   Up 19 seconds   0.0.0.0:5432->5432/tcp, :::5432->5432/tcp   nautobot_connectivity_matrix_postgres_1
96c6ff66997c   redis:6-alpine                   "docker-entrypoint.s…"   25 seconds ago   Up 21 seconds   0.0.0.0:6379->6379/tcp, :::6379->6379/tcp   nautobot_connectivity_matrix_redis_1
```
...
Stopping nautobot_connectivity_matrix_worker_1   ...
Stopping nautobot_connectivity_matrix_nautobot_1 ...
Stopping nautobot_connectivity_matrix_docs_1     ...
Stopping nautobot_connectivity_matrix_redis_1    ...
Stopping nautobot_connectivity_matrix_postgres_1 ...
Stopping nautobot_connectivity_matrix_worker_1   ... done
Stopping nautobot_connectivity_matrix_nautobot_1 ... done
Stopping nautobot_connectivity_matrix_postgres_1 ... done
Stopping nautobot_connectivity_matrix_redis_1    ... done
Stopping nautobot_connectivity_matrix_docs_1     ... done
Removing nautobot_connectivity_matrix_worker_1   ...
Removing nautobot_connectivity_matrix_nautobot_1 ...
Removing nautobot_connectivity_matrix_docs_1     ...
Removing nautobot_connectivity_matrix_redis_1    ...
Removing nautobot_connectivity_matrix_postgres_1 ...
Removing nautobot_connectivity_matrix_postgres_1 ... done
Removing nautobot_connectivity_matrix_docs_1     ... done
Removing nautobot_connectivity_matrix_worker_1   ... done
Removing nautobot_connectivity_matrix_redis_1    ... done
Removing nautobot_connectivity_matrix_nautobot_1 ... done
Removing network nautobot_connectivity_matrix_default
```
...
So for example, our app is named `nautobot-connectivity-matrix`, the command would most likely be `docker logs nautobot_connectivity_matrix_nautobot_1 -f`. You can find the name of all running containers via `docker ps`.
...
```python
namespace = Collection("nautobot_connectivity_matrix")
namespace.configure(
    {
        "nautobot_connectivity_matrix": {
            ...
...
Or set the `INVOKE_NAUTOBOT_CONNECTIVITY_MATRIX_PYTHON_VER` variable.
...
Or set the `INVOKE_NAUTOBOT_CONNECTIVITY_MATRIX_NAUTOBOT_VER` variable.
...
In the package source, there is the `nautobot_connectivity_matrix/app-config-schema.json` file, conforming to the [JSON Schema](https://json-schema.org/) format. This file is used to validate the configuration of the app in CI pipelines.
