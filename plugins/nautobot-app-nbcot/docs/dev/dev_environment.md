...
- `project_name`: the default docker compose project name (default: `nbcot`)
...
Using **Invoke** these configuration options can be overridden using [several methods](https://docs.pyinvoke.org/en/stable/concepts/configuration.html). Perhaps the simplest is setting an environment variable `INVOKE_NBCOT_VARIABLE_NAME` where `VARIABLE_NAME` is the variable you are trying to override. The only exception is `compose_files`, because it is a list it must be overridden in a YAML file. There is an example `invoke.yml` (`invoke.example.yml`) in this directory which can be used as a starting point.
...
#14 naming to docker.io/nbcot/nautobot:3.0.0-py3.12 done
```
...
Creating network "nbcot_default" with the default driver
Creating volume "nbcot_postgres_data" with default driver
Creating nbcot_redis_1 ...
Creating nbcot_docs_1  ...
Creating nbcot_postgres_1 ...
Creating nbcot_postgres_1 ... done
Creating nbcot_redis_1    ... done
Creating nbcot_nautobot_1 ...
Creating nbcot_docs_1     ... done
Creating nbcot_nautobot_1 ... done
Creating nbcot_worker_1   ...
Creating nbcot_worker_1   ... done
...
ee90fbfabd77   nbcot/nautobot:3.0.0-py3.12  "nautobot-server rqw…"   16 seconds ago   Up 13 seconds                                               nbcot_worker_1
b8adb781d013   nbcot/nautobot:3.0.0-py3.12  "/docker-entrypoint.…"   20 seconds ago   Up 15 seconds   0.0.0.0:8080->8080/tcp, :::8080->8080/tcp   nbcot_nautobot_1
d64ebd60675d   nbcot/nautobot:3.0.0-py3.12  "mkdocs serve -v -a …"   25 seconds ago   Up 18 seconds   0.0.0.0:8001->8080/tcp, :::8001->8080/tcp   nbcot_docs_1
e72d63129b36   postgres:13-alpine               "docker-entrypoint.s…"   25 seconds ago   Up 19 seconds   0.0.0.0:5432->5432/tcp, :::5432->5432/tcp   nbcot_postgres_1
96c6ff66997c   redis:6-alpine                   "docker-entrypoint.s…"   25 seconds ago   Up 21 seconds   0.0.0.0:6379->6379/tcp, :::6379->6379/tcp   nbcot_redis_1
```
...
Stopping nbcot_worker_1   ...
Stopping nbcot_nautobot_1 ...
Stopping nbcot_docs_1     ...
Stopping nbcot_redis_1    ...
Stopping nbcot_postgres_1 ...
Stopping nbcot_worker_1   ... done
Stopping nbcot_nautobot_1 ... done
Stopping nbcot_postgres_1 ... done
Stopping nbcot_redis_1    ... done
Stopping nbcot_docs_1     ... done
Removing nbcot_worker_1   ...
Removing nbcot_nautobot_1 ...
Removing nbcot_docs_1     ...
Removing nbcot_redis_1    ...
Removing nbcot_postgres_1 ...
Removing nbcot_postgres_1 ... done
Removing nbcot_docs_1     ... done
Removing nbcot_worker_1   ... done
Removing nbcot_redis_1    ... done
Removing nbcot_nautobot_1 ... done
Removing network nbcot_default
```
...
So for example, our app is named `nbcot`, the command would most likely be `docker logs nbcot_nautobot_1 -f`. You can find the name of all running containers via `docker ps`.
...
Or set the `INVOKE_NBCOT_PYTHON_VER` variable.
...
Or set the `INVOKE_NBCOT_NAUTOBOT_VER` variable.
...
In the package source, there is the `nbcot/app-config-schema.json` file, conforming to the [JSON Schema](https://json-schema.org/) format. This file is used to validate the configuration of the app in CI pipelines.
