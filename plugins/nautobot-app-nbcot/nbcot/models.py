...
class CiscoOrder(PrimaryModel):  # pylint: disable=too-many-ancestors
    ...
    project_number = models.CharField(max_length=CHARFIELD_MAX_LENGTH, blank=True)
    notes = models.TextField(blank=True)
    notification_recipients = models.TextField(blank=True)
    notification_teams_webhook_url = models.URLField(max_length=1024, blank=True)
    web_order_url = models.URLField(max_length=1024, blank=True)
    cisco_sales_order_url = models.URLField(max_length=1024, blank=True)
...
class CiscoOrderLine(BaseModel):
    ...
    parent_serial_number = models.CharField(max_length=CHARFIELD_MAX_LENGTH, blank=True)
    mac_address = models.CharField(max_length=CHARFIELD_MAX_LENGTH, blank=True)
    imei_number = models.CharField(max_length=CHARFIELD_MAX_LENGTH, blank=True)
    instance_number = models.CharField(max_length=CHARFIELD_MAX_LENGTH, blank=True)
    license_key = models.CharField(max_length=CHARFIELD_MAX_LENGTH, blank=True)
    cloud_id = models.CharField(max_length=CHARFIELD_MAX_LENGTH, blank=True)
    contract_number = models.CharField(max_length=CHARFIELD_MAX_LENGTH, blank=True)
