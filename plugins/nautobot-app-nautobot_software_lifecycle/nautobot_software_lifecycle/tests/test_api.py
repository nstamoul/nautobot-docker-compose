"""Unit tests for nautobot_software_lifecycle."""
...
class Nautobot_Software_LifecycleExampleModelAPIViewTest(APIViewTestCases.APIViewTestCase):
    # pylint: disable=too-many-ancestors
    """Test the API viewsets for Nautobot_Software_LifecycleExampleModel."""
    ...
    def setUpTestData(cls):
        """Create test data for Nautobot_Software_LifecycleExampleModel API viewset."""
        super().setUpTestData()
